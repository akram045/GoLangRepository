/*
 	create a page which illustrates what happens when a user changes a cookie.
					You can hard-code a changed cookie into your code.
Change the cookie on the client by running the following JS: document.cookie="userData=new data"
